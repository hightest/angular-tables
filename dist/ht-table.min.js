 ...
 * License: 
 */
!function(){function e(){function e(e,t,n,a){function l(){n.when(e.data).then(function(e){B=e,r()})}function i(){var t={activeStyle:"active",showFilters:!0,pagination:{total:0,current:1,itemsPerPage:10,show:!0},filters:[],selectFilters:[],sorting:[],selectMultiple:!1,expanded:null,expand:!1,onClick:function(){}};R=angular.merge({},t,e.settings),R.expanded=e.settings.expanded,_.data=[],_.fieldFilter={visible:!0},_.pagination=R.pagination,_.filters=e.settings.filters?e.settings.filters:[],_.filterFields=[{name:"Wszędzie",field:"$"}].concat(R.fields),_.selectFilters=R.selectFilters,_.expanded=R.expanded,R.comparator=R.comparator||b,h()}function r(){R.expanded=e.settings.expanded,o(),u(),null!==R.expanded&&n.when(R.expanded).then(function(e){_.expanded=e,p(e)})}function o(){var e=d(),t=e.length;if(t)for(var n=B.length,a=0;n>a;a++){var l=B[a];s(l,e)}}function s(e,t){var n=t.length;angular.isDefined(e.$htTable)||(e.$htTable={});for(var a=0;n>a;a++)e.$htTable["field"+t[a].index]=t[a].value(e)}function d(){for(var e=_.fields.length,t=[],n=0;e>n;n++){var a=_.fields[n];angular.isDefined(a.value)&&(a.index=n,a.field="$htTable.field"+n,t.push(a))}return t}function u(){E(),y(),R.pagination.current=1,f()}function f(){y(),g()}function g(){P()}function c(e){R.onClick(e),R.selectMultiple||(Q&&(Q.$htTable.selected=!1),Q=e,e.$htTable||(e.$htTable={}),e.$htTable.selected=!0),R.expand&&(_.expanded=_.expanded==e?null:e)}function p(e){for(var t=J.length,n=0,a=0;t>a;a++)if(R.comparator(J[a],e)){n=a;break}_.expanded=J[a],R.pagination.current=parseInt(n/R.pagination.itemsPerPage)+1,g()}function b(e,t){return angular.equals(e,t)}function h(){for(var e=0,t=R.fields.length;t>e;e++){var n=R.fields[e];(angular.isUndefined(n.visible)||n.visible)&&(n.visible=!0)}_.fields=R.fields}function v(){var e=1;return R.selectMultiple&&e++,e+=t("field")(_.fields).length}function m(){return R.showFilters}function T(){return R.selectMultiple}function y(){for(var e=[],n=0,a=R.sorting.length;a>n;n++){var l=R.sorting[n],i="";i="asc"==l.sort?"+":"-",i+=l.field,e.push(i)}J=R.sorting.length?t("natural")(G,e):G}function P(){var e=R.pagination;if(e.total=J.length,_.data=e.itemsPerPage?J.slice((e.current-1)*e.itemsPerPage,e.current*e.itemsPerPage):J,R.selectMultiple){_.allSelected=!0;for(var t=0,n=_.data.length;n>t;t++)if(!_.data[t].$htTable||_.data[t].$htTable.selected!==!0){_.allSelected=!1;break}}}function x(){var e=R.pagination;return!(!e.show||e.total<=10)}function $(){g()}function w(){return(R.pagination.current-1)*R.pagination.itemsPerPage}function k(e){return angular.isDefined(e.$htTable)&&e.$htTable.selected?R.activeStyle:""}function F(){for(var e=0,t=_.fields.length;t>e;e++)if(angular.isDefined(_.fields[e].type)&&"sum"==_.fields[e].type)return!0;return!1}function S(e){for(var n=0,a=G.length,l=0,i=!0,r=0;a>r;r++){var o=G[r];l+=M(e,o,!0),angular.isDefined(o.$htTable)&&o.$htTable.selected&&(n+=M(e,o,!0),i=!1)}return angular.isDefined(e.filter)&&(n=t(e.filter)(n),l=t(e.filter)(l)),i?l:n}function M(e,n,a){if(!angular.isUndefined(e.field)){for(var l=e.field,i=l.split("."),r=n,o=0,s=i.length;s>o;o++){var d=i[o];if(null===r||!r.hasOwnProperty(d))return"";r=r[d]}return angular.isDefined(e.filter)&&!a&&(r=t(e.filter)(r)),r}}function D(e,t){var n=t.shiftKey,a=A(e),l={};if(l=null===a?{field:e.field,sort:"asc"}:R.sorting[a],null!==a){var i=l.sort;"asc"==i?(R.sorting[a].sort="desc",n||(R.sorting=[R.sorting[a]])):n?R.sorting.splice(a,1):R.sorting.length=0}else n?R.sorting.push(l):(R.sorting.length=0,R.sorting.push(l));f()}function A(e){for(var t=0;t<R.sorting.length;t++)if(R.sorting[t].field==e.field)return t;return null}function C(e){for(var t=0;t<R.sorting.length;t++)if(e.field==R.sorting[t].field)return"asc"==R.sorting[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function q(){_.filters.push({filter:_.filterTypes[0].value,field:"$",value:""})}function O(e){var t=_.filters[e].value;_.filters.splice(e,1),t.length>0&&j()}function j(){X&&a.cancel(X),X=a(u,500)}function E(){var e=B,n=U(_.filters);n=V(n);for(var a in n)if(n.hasOwnProperty(a)){var l=n[a];if(l=N(l),1===l.length)if(l[0]=W(l[0]),"filter"==a&&angular.isDefined(l[0].$)&&l[0].$.length)for(var i=l[0].$,r=i.split(" "),o=0;o<r.length;o++)l[0].$=r[o],e=t(a)(e,l[0]);else e=t(a)(e,l[0]);else{for(var s=[],d=l.length,u=0;d>u;u++){var f=e.slice();if(l[u]=W(l[u]),"filter"==a&&angular.isDefined(l[u].$)&&l[u].$.length)for(var g=l[u].$,c=g.split(" "),p=0;p<c.length;p++)l[u].$=c[p],f=t(a)(f,l[u]);else f=t(a)(f,l[u]);s=s.concat(f)}for(u=0;u<s.length;u++)for(var b=u+1;b<s.length;b++)s[u]==s[b]&&s.splice(b--,1);e=s}}G=z(e)}function U(e){for(var t={},n=e.length,a=0;n>a;++a){var l=e[a];l.value.length&&(angular.isUndefined(t[l.filter])&&(t[l.filter]={}),angular.isDefined(t[l.filter][l.field])?(Array.isArray(t[l.filter][l.field])||(t[l.filter][l.field]=[t[l.filter][l.field]]),t[l.filter][l.field].push(l.value)):t[l.filter][l.field]=l.value)}return t}function z(e){for(var t=R.selectFilters,n=e.slice(),a=0,l=t.length;l>a;a++){for(var i=t[a],r=[],o=!1,s=0,d=i.options.length;d>s;s++){var u=i.options[s];if(u.selected&&angular.isFunction(u.field)){o=!0;for(var f=0,g=n.length;g>f;f++){var c=n[f],p=u.field(c);p==u.value&&-1===r.indexOf(c)&&r.push(c)}}}o&&(n=r)}return n}function V(e){for(var t=R.selectFilters,n=t.length,a=0;n>a;++a)for(var l=t[a],i=l.options.length,r=0;i>r;++r){var o=l.options[r];if(angular.isDefined(o.selected)&&o.selected){if(angular.isFunction(o.field))continue;var s=o.type,d=o.field,u=o.value;angular.isDefined(e[s])||(e[s]={}),angular.isDefined(e[s][d])&&(e[s][d].length>0||angular.isNumber(e[s][d]))?(Array.isArray(e[s][d])||(e[s][d]=[e[s][d]]),e[s][d].push(u)):e[s][d]=u}}return e}function N(e){var t=[];return angular.forEach(e,function(n,a){Array.isArray(n)&&angular.forEach(n,function(n){var l=angular.copy(e);l[a]=n,t=t.concat(N(l))})}),0===t.length&&t.push(e),t}function I(e,t,n,a){var l=e.indexOf(".");if(-1===l)a?("undefined"==typeof n[a]&&(n[a]={}),n[a][e]=t):n[e]=t;else{var i=e.split(".",1)[0],r=e.substr(l+1);a&&("undefined"==typeof n[a]&&(n[a]={}),n=n[a]),I(r,t,n,i)}}function W(e){for(var t={},n=Object.keys(e),a=0,l=n.length;l>a;a++)I(n[a],e[n[a]],t);return t}function H(){for(var e=B,t=e.length,n=[],a=[],l=0;t>l;l++){for(var i=[],r=0;r<_.fields.length;r++){var o=_.fields[r];o.visible&&!angular.isUndefined(o.field)&&i.push(M(o,e[l]))}e[l].$htTable&&e[l].$htTable.selected&&a.push(i),n.push(i)}return a.length?a:n}function L(){for(var e=[],t=0;t<_.fields.length;t++){var n=_.fields[t];n.visible&&!angular.isUndefined(n.field)&&e.push(n.name)}return e}function K(){for(var e=0,t=_.data.length;t>e;e++)_.data[e].$htTable||(_.data[e].$htTable={}),_.data[e].$htTable.selected=_.allSelected}var R,_=this,B=[],G=[],J=[];e.$watchCollection("data",function(){l()}),_.filterTypes=[{name:"Szukaj w",value:"filter"},{name:"Mniejszy od",value:"lessThanOrEqualTo"},{name:"Większy od",value:"greaterThanOrEqualTo"}],_.getIndex=w,_.rowStyle=k,_.getValue=M,_.changeSorting=D,_.getFieldClass=C,_.showPagination=x,_.updatePagination=$,_.selectMultiple=T,_.showFilters=m,_.addFilter=q,_.removeFilter=O,_.updateFilter=j,_.export=H,_.exportHeader=L,_.expand=c,_.hasSum=F,_.sum=S,_.sums={},_.countColumns=v,_.allSelected=!1,_.selectAll=K;var Q=null;n.when(e.data).then(function(e){B=e,r()}),l(),i();var X=null}return e.$inject=["$scope","$filter","$q","$timeout"],{templateUrl:"ht-table/layout.html",require:"^ngModel",scope:{settings:"=htTable",data:"=ngModel"},controllerAs:"htTable",controller:e}}function t(){return function(e,t){t[0].focus()}}function n(){return function(e){for(var t=[],n=e.length,a=0;n>a;a++)(angular.isUndefined(e[a].visible)||e[a].visible)&&t.push(e[a]);return t}}function a(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?e>=t:!1})}}function l(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?t>=e:!1})}}function i(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function l(e,t,n){var a=[];return angular.forEach(e,function(e,l,i){a.push(t.call(n,e,l,i))}),a}function i(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,s){function d(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function u(e,t){return n(t)?function(t,n){return e(n,t)}:e}function f(e,n){var a=typeof e,l=typeof n;return a==l?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):l>a?-1:1}return i(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=l(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return u(function(e,t){return f(e,t)},n);if(a=e(t),a.constant){var l=a();return u(function(e,t){return f(e[l],t[l])},n)}}return u(function(e,t){return f(a(e),a(t))},n)}),r.call(a).sort(u(d,s))):a}}function r(e){return{require:"^ngModel",scope:{row:"=ngModel",template:"=htTableTemplate"},controller:["$scope","$element",function(t,n){n.append(e(t.template)(t))}]}}a.$inject=["filterFilter"],l.$inject=["filterFilter"],i.$inject=["$parse","naturalService"],r.$inject=["$compile"],angular.module("ht.tables",["ui.bootstrap","naturalSort","ngSanitize","ngCsv"]).directive("htTable",e).directive("htFocus",t).directive("htTableTemplate",r).filter("greaterThanOrEqualTo",a).filter("lessThanOrEqualTo",l).filter("natural",i).filter("field",n)}(),/*!
