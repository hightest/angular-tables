 ...
 * License: 
 */
!function(){function e(){function e(e,t,n,a){function l(){n.when(e.data).then(function(e){R=e,r()})}function i(){var t={activeStyle:"active",showFilters:!0,pagination:{total:0,current:1,itemsPerPage:10,show:!0},filters:[],selectFilters:[],sorting:[],selectMultiple:!1,expanded:null,expand:!1,onClick:function(){}};L=angular.merge({},t,e.settings),L.expanded=e.settings.expanded,K.data=[],K.fieldFilter={visible:!0},K.pagination=L.pagination,K.filters=e.settings.filters?e.settings.filters:[],K.filterFields=[{name:"Wszędzie",field:"$"}].concat(L.fields),K.selectFilters=L.selectFilters,K.expanded=L.expanded,L.comparator=L.comparator||b,h()}function r(){L.expanded=e.settings.expanded,o(),d(),null!==L.expanded&&n.when(L.expanded).then(function(e){K.expanded=e,p(e)})}function o(){var e=u(),t=e.length;if(t)for(var n=R.length,a=0;n>a;a++){var l=R[a];s(l,e)}}function s(e,t){var n=t.length;angular.isDefined(e.$htTable)||(e.$htTable={});for(var a=0;n>a;a++)e.$htTable["field"+t[a].index]=t[a].value(e)}function u(){for(var e=K.fields.length,t=[],n=0;e>n;n++){var a=K.fields[n];angular.isDefined(a.value)&&(a.index=n,a.field="$htTable.field"+n,t.push(a))}return t}function d(){U(),y(),L.pagination.current=1,g()}function g(){y(),f()}function f(){P()}function c(e){L.onClick(e),L.selectMultiple||(G&&(G.$htTable.selected=!1),G=e,e.$htTable||(e.$htTable={}),e.$htTable.selected=!0),L.expand&&(K.expanded=K.expanded==e?null:e)}function p(e){for(var t=B.length,n=0,a=0;t>a;a++)if(L.comparator(B[a],e)){n=a;break}K.expanded=B[a],L.pagination.current=parseInt(n/L.pagination.itemsPerPage)+1,f()}function b(e,t){return angular.equals(e,t)}function h(){for(var e=0,t=L.fields.length;t>e;e++){var n=L.fields[e];(angular.isUndefined(n.visible)||n.visible)&&(n.visible=!0)}K.fields=L.fields}function v(){var e=1;return L.selectMultiple&&e++,e+=t("field")(K.fields).length}function m(){return L.showFilters}function T(){return L.selectMultiple}function y(){for(var e=[],n=0,a=L.sorting.length;a>n;n++){var l=L.sorting[n],i="";i="asc"==l.sort?"+":"-",i+=l.field,e.push(i)}B=L.sorting.length?t("natural")(_,e):_}function P(){var e=L.pagination;e.total=B.length,K.data=e.itemsPerPage?B.slice((e.current-1)*e.itemsPerPage,e.current*e.itemsPerPage):B}function x(){var e=L.pagination;return!(!e.show||e.total<=10)}function w(){f()}function $(){return(L.pagination.current-1)*L.pagination.itemsPerPage}function k(e){return angular.isDefined(e.$htTable)&&e.$htTable.selected?L.activeStyle:""}function F(){for(var e=0,t=K.fields.length;t>e;e++)if(angular.isDefined(K.fields[e].type)&&"sum"==K.fields[e].type)return!0;return!1}function S(e){for(var t=0,n=_.length,a=0,l=!0,i=0;n>i;i++){var r=_[i];a+=r[e],angular.isDefined(r.$htTable)&&r.$htTable.selected&&(t+=r[e],l=!1)}return l?a:t}function D(e,n){if(!angular.isUndefined(e.field)){for(var a=e.field,l=a.split("."),i=n,r=0,o=l.length;o>r;r++){var s=l[r];if(null===i||!i.hasOwnProperty(s))return"";i=i[s]}return angular.isDefined(e.filter)&&(i=t(e.filter)(i)),i}}function M(e,t){var n=t.shiftKey,a=C(e),l={};if(l=null===a?{field:e.field,sort:"asc"}:L.sorting[a],null!==a){var i=l.sort;"asc"==i?(L.sorting[a].sort="desc",n||(L.sorting=[L.sorting[a]])):n?L.sorting.splice(a,1):L.sorting.length=0}else n?L.sorting.push(l):(L.sorting.length=0,L.sorting.push(l));g()}function C(e){for(var t=0;t<L.sorting.length;t++)if(L.sorting[t].field==e.field)return t;return null}function A(e){for(var t=0;t<L.sorting.length;t++)if(e.field==L.sorting[t].field)return"asc"==L.sorting[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function q(){K.filters.push({filter:K.filterTypes[0].value,field:"$",value:""})}function E(e){var t=K.filters[e].value;K.filters.splice(e,1),t.length>0&&O()}function O(){J&&a.cancel(J),J=a(d,500)}function U(){var e=R,n=j(K.filters);n=z(n);for(var a in n)if(n.hasOwnProperty(a)){var l=n[a];if(l=V(l),1===l.length)if(l[0]=I(l[0]),"filter"==a&&angular.isDefined(l[0].$)&&l[0].$.length)for(var i=l[0].$,r=i.split(" "),o=0;o<r.length;o++)l[0].$=r[o],e=t(a)(e,l[0]);else e=t(a)(e,l[0]);else{for(var s=[],u=l.length,d=0;u>d;d++){var g=e.slice();if(l[d]=I(l[d]),"filter"==a&&angular.isDefined(l[d].$)&&l[d].$.length)for(var f=l[d].$,c=f.split(" "),p=0;p<c.length;p++)l[d].$=c[p],g=t(a)(g,l[d]);else g=t(a)(g,l[d]);s=s.concat(g)}for(d=0;d<s.length;d++)for(var b=d+1;b<s.length;b++)s[d]==s[b]&&s.splice(b--,1);e=s}}_=e}function j(e){for(var t={},n=e.length,a=0;n>a;++a){var l=e[a];l.value.length&&(angular.isUndefined(t[l.filter])&&(t[l.filter]={}),angular.isDefined(t[l.filter][l.field])?(Array.isArray(t[l.filter][l.field])||(t[l.filter][l.field]=[t[l.filter][l.field]]),t[l.filter][l.field].push(l.value)):t[l.filter][l.field]=l.value)}return t}function z(e){for(var t=L.selectFilters,n=t.length,a=0;n>a;++a)for(var l=t[a],i=l.options.length,r=0;i>r;++r){var o=l.options[r];if(angular.isDefined(o.selected)&&o.selected){var s=o.type,u=o.field,d=o.value;angular.isDefined(e[s])||(e[s]={}),angular.isDefined(e[s][u])&&(e[s][u].length>0||angular.isNumber(e[s][u]))?(Array.isArray(e[s][u])||(e[s][u]=[e[s][u]]),e[s][u].push(d)):e[s][u]=d}}return e}function V(e){var t=[];return angular.forEach(e,function(n,a){Array.isArray(n)&&angular.forEach(n,function(n){var l=angular.copy(e);l[a]=n,t=t.concat(V(l))})}),0===t.length&&t.push(e),t}function N(e,t,n,a){var l=e.indexOf(".");if(-1===l)a?("undefined"==typeof n[a]&&(n[a]={}),n[a][e]=t):n[e]=t;else{var i=e.split(".",1)[0],r=e.substr(l+1);a&&("undefined"==typeof n[a]&&(n[a]={}),n=n[a]),N(r,t,n,i)}}function I(e){for(var t={},n=Object.keys(e),a=0,l=n.length;l>a;a++)N(n[a],e[n[a]],t);return t}function W(){for(var e=R,t=e.length,n=[],a=0;t>a;a++){for(var l=[],i=0;i<K.fields.length;i++){var r=K.fields[i];r.visible&&!angular.isUndefined(r.field)&&l.push(D(r,e[a]))}n.push(l)}return n}function H(){for(var e=[],t=0;t<K.fields.length;t++){var n=K.fields[t];n.visible&&!angular.isUndefined(n.field)&&e.push(n.name)}return e}var L,K=this,R=[],_=[],B=[];e.$watchCollection("data",function(){l()}),K.filterTypes=[{name:"Szukaj w",value:"filter"},{name:"Mniejszy od",value:"lessThanOrEqualTo"},{name:"Większy od",value:"greaterThanOrEqualTo"}],K.getIndex=$,K.rowStyle=k,K.getValue=D,K.changeSorting=M,K.getFieldClass=A,K.showPagination=x,K.updatePagination=w,K.selectMultiple=T,K.showFilters=m,K.addFilter=q,K.removeFilter=E,K.updateFilter=O,K.export=W,K.exportHeader=H,K.expand=c,K.hasSum=F,K.sum=S,K.sums={},K.countColumns=v;var G=null;n.when(e.data).then(function(e){R=e,r()}),l(),i();var J=null}return e.$inject=["$scope","$filter","$q","$timeout"],{templateUrl:"ht-table/layout.html",require:"^ngModel",scope:{settings:"=htTable",data:"=ngModel"},controllerAs:"htTable",controller:e}}function t(){return function(e,t){t[0].focus()}}function n(){return function(e){for(var t=[],n=e.length,a=0;n>a;a++)(angular.isUndefined(e[a].visible)||e[a].visible)&&t.push(e[a]);return t}}function a(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?e>=t:!1})}}function l(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?t>=e:!1})}}function i(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function l(e,t,n){var a=[];return angular.forEach(e,function(e,l,i){a.push(t.call(n,e,l,i))}),a}function i(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,s){function u(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function d(e,t){return n(t)?function(t,n){return e(n,t)}:e}function g(e,n){var a=typeof e,l=typeof n;return a==l?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):l>a?-1:1}return i(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=l(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return d(function(e,t){return g(e,t)},n);if(a=e(t),a.constant){var l=a();return d(function(e,t){return g(e[l],t[l])},n)}}return d(function(e,t){return g(a(e),a(t))},n)}),r.call(a).sort(d(u,s))):a}}a.$inject=["filterFilter"],l.$inject=["filterFilter"],i.$inject=["$parse","naturalService"],angular.module("ht.tables",["ui.bootstrap","naturalSort","ngSanitize","ngCsv"]).directive("htTable",e).directive("htFocus",t).filter("greaterThanOrEqualTo",a).filter("lessThanOrEqualTo",l).filter("natural",i).filter("field",n)}(),/*!
