 ...
 * License: 
 */
!function(){function e(){function e(e,t,n,a){function l(){n.when(e.data).then(function(e){H=e,r()})}function i(){var t={activeStyle:"active",showFilters:!0,pagination:{total:0,current:1,itemsPerPage:10,show:!0},filters:[],selectFilters:[],sorting:[],selectMultiple:!1,expanded:null,expand:!1,onClick:function(){}};I=angular.merge({},t,e.settings),I.expanded=e.settings.expanded,W.data=[],W.fieldFilter={visible:!0},W.pagination=I.pagination,W.filters=I.filters,W.filterFields=[{name:"Wszędzie",field:"$"}].concat(I.fields),W.selectFilters=I.selectFilters,W.expanded=I.expanded,I.comparator=I.comparator||c,f()}function r(){o(),null!==I.expanded&&n.when(I.expanded).then(function(e){W.expanded=e,g(e)})}function o(){q(),v(),I.pagination.current=1,s()}function s(){v(),u()}function u(){m()}function d(e){I.onClick(e),I.selectMultiple||(R&&(R.$htTable.selected=!1),R=e,e.$htTable||(e.$htTable={}),e.$htTable.selected=!0),I.expand&&(W.expanded=W.expanded==e?null:e)}function g(e){for(var t=K.length,n=0,a=0;t>a;a++)if(I.comparator(K[a],e)){n=a;break}W.expanded=K[a],I.pagination.current=parseInt(n/I.pagination.itemsPerPage)+1,u()}function c(e,t){return angular.equals(e,t)}function f(){for(var e=0,t=I.fields.length;t>e;e++){var n=I.fields[e];(angular.isUndefined(n.visible)||n.visible)&&(n.visible=!0)}W.fields=I.fields}function p(){var e=1;return I.selectMultiple&&e++,e+=t("field")(W.fields).length}function b(){return I.showFilters}function h(){return I.selectMultiple}function v(){for(var e=[],n=0,a=I.sorting.length;a>n;n++){var l=I.sorting[n],i="";i="asc"==l.sort?"+":"-",i+=l.field,e.push(i)}K=I.sorting.length?t("natural")(L,e):L}function m(){var e=I.pagination;e.total=K.length,W.data=e.itemsPerPage?K.slice((e.current-1)*e.itemsPerPage,e.current*e.itemsPerPage):K}function T(){var e=I.pagination;return!(!e.show||e.total<=10)}function y(){u()}function P(){return(I.pagination.current-1)*I.pagination.itemsPerPage}function x(e){return angular.isDefined(e.$htTable)&&e.$htTable.selected?I.activeStyle:""}function w(){for(var e=0,t=W.fields.length;t>e;e++)if(angular.isDefined(W.fields[e].type)&&"sum"==W.fields[e].type)return!0;return!1}function $(e){for(var t=0,n=L.length,a=0,l=!0,i=0;n>i;i++){var r=L[i];a+=r[e],angular.isDefined(r.$htTable)&&r.$htTable.selected&&(t+=r[e],l=!1)}return l?a:t}function k(e,n){if(!angular.isUndefined(e.field)){for(var a=e.field,l=a.split("."),i=n,r=0,o=l.length;o>r;r++){var s=l[r];if(null===i||!i.hasOwnProperty(s))return"";i=i[s]}return angular.isDefined(e.filter)&&(i=t(e.filter)(i)),i}}function F(e,t){var n=t.shiftKey,a=S(e),l={};if(l=null===a?{field:e.field,sort:"asc"}:I.sorting[a],null!==a){var i=l.sort;"asc"==i?(I.sorting[a].sort="desc",n||(I.sorting=[I.sorting[a]])):n?I.sorting.splice(a,1):I.sorting.length=0}else n?I.sorting.push(l):(I.sorting.length=0,I.sorting.push(l));s()}function S(e){for(var t=0;t<I.sorting.length;t++)if(I.sorting[t].field==e.field)return t;return null}function M(e){for(var t=0;t<I.sorting.length;t++)if(e.field==I.sorting[t].field)return"asc"==I.sorting[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function C(){W.filters.push({filter:W.filterTypes[0].value,field:"$",value:""})}function A(e){var t=W.filters[e].value;W.filters.splice(e,1),t.length>0&&D()}function D(){_&&a.cancel(_),_=a(o,500)}function q(){var e=H,n=E(W.filters);n=O(n);for(var a in n)if(n.hasOwnProperty(a)){var l=n[a];if(l=U(l),1===l.length)if(l[0]=z(l[0]),"filter"==a&&angular.isDefined(l[0].$)&&l[0].$.length)for(var i=l[0].$,r=i.split(" "),o=0;o<r.length;o++)l[0].$=r[o],e=t(a)(e,l[0]);else e=t(a)(e,l[0]);else{for(var s=[],u=l.length,d=0;u>d;d++){var g=e.slice();if("filter"==a&&angular.isDefined(l[d].$)&&l[d].$.length)for(var c=l[d].$,f=c.split(" "),p=0;p<f.length;p++)l[d].$=f[p],g=t(a)(g,l[d]);else g=t(a)(g,l[d]);s=s.concat(g)}for(d=0;d<s.length;d++)for(var b=d+1;b<s.length;b++)s[d]==s[b]&&s.splice(b--,1);e=s}}L=e}function E(e){for(var t={},n=e.length,a=0;n>a;++a){var l=e[a];l.value.length&&(angular.isUndefined(t[l.filter])&&(t[l.filter]={}),angular.isDefined(t[l.filter][l.field])?(Array.isArray(t[l.filter][l.field])||(t[l.filter][l.field]=[t[l.filter][l.field]]),t[l.filter][l.field].push(l.value)):t[l.filter][l.field]=l.value)}return t}function O(e){for(var t=I.selectFilters,n=t.length,a=0;n>a;++a)for(var l=t[a],i=l.options.length,r=0;i>r;++r){var o=l.options[r];if(angular.isDefined(o.selected)&&o.selected){var s=o.type,u=o.field,d=o.value;angular.isDefined(e[s])||(e[s]={}),angular.isDefined(e[s][u])&&(e[s][u].length>0||angular.isNumber(e[s][u]))?(Array.isArray(e[s][u])||(e[s][u]=[e[s][u]]),e[s][u].push(d)):e[s][u]=d}}return e}function U(e){var t=[];return angular.forEach(e,function(n,a){Array.isArray(n)&&angular.forEach(n,function(n){var l=angular.copy(e);l[a]=n,t=t.concat(U(l))})}),0===t.length&&t.push(e),t}function j(e,t,n,a){var l=e.indexOf(".");if(-1===l)a?("undefined"==typeof n[a]&&(n[a]={}),n[a][e]=t):n[e]=t;else{var i=e.split(".",1)[0],r=e.substr(l+1);a&&("undefined"==typeof n[a]&&(n[a]={}),n=n[a]),j(r,t,n,i)}}function z(e){for(var t={},n=Object.keys(e),a=0,l=n.length;l>a;a++)j(n[a],e[n[a]],t);return t}function V(){for(var e=H,t=e.length,n=[],a=0;t>a;a++){for(var l=[],i=0;i<W.fields.length;i++){var r=W.fields[i];r.visible&&!angular.isUndefined(r.field)&&l.push(k(r,e[a]))}n.push(l)}return n}function N(){for(var e=[],t=0;t<W.fields.length;t++){var n=W.fields[t];n.visible&&!angular.isUndefined(n.field)&&e.push(n.name)}return e}var I,W=this,H=[],L=[],K=[];e.$watchCollection("data",function(){l()}),W.filterTypes=[{name:"Szukaj w",value:"filter"},{name:"Mniejszy od",value:"lessThanOrEqualTo"},{name:"Większy od",value:"greaterThanOrEqualTo"}],W.getIndex=P,W.rowStyle=x,W.getValue=k,W.changeSorting=F,W.getFieldClass=M,W.showPagination=T,W.updatePagination=y,W.selectMultiple=h,W.showFilters=b,W.addFilter=C,W.removeFilter=A,W.updateFilter=D,W.export=V,W.exportHeader=N,W.expand=d,W.hasSum=w,W.sum=$,W.sums={},W.countColumns=p;var R=null;n.when(e.data).then(function(e){H=e,r()}),l(),i();var _=null}return e.$inject=["$scope","$filter","$q","$timeout"],{templateUrl:"ht-table/layout.html",require:"^ngModel",scope:{settings:"=htTable",data:"=ngModel"},controllerAs:"htTable",controller:e}}function t(){return function(e,t){t[0].focus()}}function n(){return function(e){for(var t=[],n=e.length,a=0;n>a;a++)(angular.isUndefined(e[a].visible)||e[a].visible)&&t.push(e[a]);return t}}function a(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?e>=t:!1})}}function l(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?t>=e:!1})}}function i(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function l(e,t,n){var a=[];return angular.forEach(e,function(e,l,i){a.push(t.call(n,e,l,i))}),a}function i(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,s){function u(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function d(e,t){return n(t)?function(t,n){return e(n,t)}:e}function g(e,n){var a=typeof e,l=typeof n;return a==l?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):l>a?-1:1}return i(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=l(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return d(function(e,t){return g(e,t)},n);if(a=e(t),a.constant){var l=a();return d(function(e,t){return g(e[l],t[l])},n)}}return d(function(e,t){return g(a(e),a(t))},n)}),r.call(a).sort(d(u,s))):a}}a.$inject=["filterFilter"],l.$inject=["filterFilter"],i.$inject=["$parse","naturalService"],angular.module("ht.tables",["ui.bootstrap","naturalSort","ngSanitize","ngCsv"]).directive("htTable",e).directive("htFocus",t).filter("greaterThanOrEqualTo",a).filter("lessThanOrEqualTo",l).filter("natural",i).filter("field",n)}(),/*!
