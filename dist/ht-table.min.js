 ...
 * License: 
 */
!function(){function e(){function e(e,t,n,a){function l(){var t={activeStyle:"active",showFilters:!0,pagination:{total:0,current:1,itemsPerPage:10,show:!0},filters:[],selectFilters:[],sorting:[],selectMultiple:!1,expanded:null,onClick:function(){}};z=angular.merge({},t,e.settings),V.data=[],V.fieldFilter={visible:!0},V.pagination=z.pagination,V.filters=z.filters,V.filterFields=[{name:"Wszędzie",field:"$"}].concat(z.fields),V.selectFilters=z.selectFilters,V.expanded=z.expanded,d(),i(),null!==V.expanded&&u(V.expanded)}function i(){A(),p(),z.pagination.current=1,r()}function r(){p(),o()}function o(){b()}function s(e){V.expanded=V.expanded==e?null:e,z.onClick(e)}function u(e){for(var t=W.length,n=0,a=0;t>a;a++)if(angular.equals(W[a],e)){n=a;break}V.expanded=W[a],z.pagination.current=parseInt(n/z.pagination.itemsPerPage)+1,o()}function d(){for(var e=0,t=z.fields.length;t>e;e++){var n=z.fields[e];(angular.isUndefined(n.visible)||n.visible)&&(n.visible=!0)}V.fields=z.fields}function g(){var e=1;return z.selectMultiple&&e++,e+=t("field")(V.fields).length}function f(){return z.showFilters}function c(){return z.selectMultiple}function p(){for(var e=[],n=0,a=z.sorting.length;a>n;n++){var l=z.sorting[n],i="";i="asc"==l.sort?"+":"-",i+=l.field,e.push(i)}W=z.sorting.length?t("natural")(I,e):I}function b(){var e=z.pagination;e.total=W.length,V.data=e.itemsPerPage?W.slice((e.current-1)*e.itemsPerPage,e.current*e.itemsPerPage):W}function h(){var e=z.pagination;return!(!e.show||e.total<=10)}function v(){o()}function m(){return(z.pagination.current-1)*z.pagination.itemsPerPage}function T(e){return angular.isDefined(e.$htTable)&&e.$htTable.selected?z.activeStyle:""}function y(){for(var e=0,t=V.fields.length;t>e;e++)if(angular.isDefined(V.fields[e].type)&&"sum"==V.fields[e].type)return!0;return!1}function P(e){for(var t=0,n=I.length,a=0;n>a;a++){var l=I[a];angular.isDefined(l.$htTable)&&l.$htTable.selected&&(t+=l[e])}return t}function x(e,n){if(!angular.isUndefined(e.field)){for(var a=e.field,l=a.split("."),i=n,r=0,o=l.length;o>r;r++){var s=l[r];if(null===i||!i.hasOwnProperty(s))return"";i=i[s]}return angular.isDefined(e.filter)&&(i=t(e.filter)(i)),i}}function w(e,t){var n=t.shiftKey,a=$(e),l={};if(l=null===a?{field:e.field,sort:"asc"}:z.sorting[a],null!==a){var i=l.sort;"asc"==i?(z.sorting[a].sort="desc",n||(z.sorting=[z.sorting[a]])):n?z.sorting.splice(a,1):z.sorting.length=0}else n?z.sorting.push(l):(z.sorting.length=0,z.sorting.push(l));r()}function $(e){for(var t=0;t<z.sorting.length;t++)if(z.sorting[t].field==e.field)return t;return null}function k(e){for(var t=0;t<z.sorting.length;t++)if(e.field==z.sorting[t].field)return"asc"==z.sorting[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function F(){V.filters.push({filter:V.filterTypes[0].value,field:"$",value:""})}function S(e){var t=V.filters[e].value;V.filters.splice(e,1),t.length>0&&M()}function M(){H&&a.cancel(H),H=a(i,500)}function A(){var e=N,n=C(V.filters);n=D(n);for(var a in n)if(n.hasOwnProperty(a)){var l=n[a];if(l=q(l),1===l.length)if(l[0]=O(l[0]),"filter"==a&&angular.isDefined(l[0].$)&&l[0].$.length)for(var i=l[0].$,r=i.split(" "),o=0;o<r.length;o++)l[0].$=r[o],e=t(a)(e,l[0]);else e=t(a)(e,l[0]);else{for(var s=[],u=l.length,d=0;u>d;d++){var g=e.slice();if("filter"==a&&angular.isDefined(l[d].$)&&l[d].$.length)for(var f=l[d].$,c=f.split(" "),p=0;p<c.length;p++)l[d].$=c[p],g=t(a)(g,l[d]);else g=t(a)(g,l[d]);s=s.concat(g)}for(d=0;d<s.length;d++)for(var b=d+1;b<s.length;b++)s[d]==s[b]&&s.splice(b--,1);e=s}}I=e}function C(e){for(var t={},n=e.length,a=0;n>a;++a){var l=e[a];l.value.length&&(angular.isUndefined(t[l.filter])&&(t[l.filter]={}),angular.isDefined(t[l.filter][l.field])?(Array.isArray(t[l.filter][l.field])||(t[l.filter][l.field]=[t[l.filter][l.field]]),t[l.filter][l.field].push(l.value)):t[l.filter][l.field]=l.value)}return t}function D(e){for(var t=z.selectFilters,n=t.length,a=0;n>a;++a)for(var l=t[a],i=l.options.length,r=0;i>r;++r){var o=l.options[r];if(angular.isDefined(o.selected)&&o.selected){var s=o.type,u=o.field,d=o.value;angular.isDefined(e[s])||(e[s]={}),angular.isDefined(e[s][u])&&(e[s][u].length>0||angular.isNumber(e[s][u]))?(Array.isArray(e[s][u])||(e[s][u]=[e[s][u]]),e[s][u].push(d)):e[s][u]=d}}return e}function q(e){var t=[];return angular.forEach(e,function(n,a){Array.isArray(n)&&angular.forEach(n,function(n){var l=angular.copy(e);l[a]=n,t=t.concat(q(l))})}),0===t.length&&t.push(e),t}function E(e,t,n,a){var l=e.indexOf(".");if(-1===l)a?("undefined"==typeof n[a]&&(n[a]={}),n[a][e]=t):n[e]=t;else{var i=e.split(".",1)[0],r=e.substr(l+1);a&&("undefined"==typeof n[a]&&(n[a]={}),n=n[a]),E(r,t,n,i)}}function O(e){for(var t={},n=Object.keys(e),a=0,l=n.length;l>a;a++)E(n[a],e[n[a]],t);return t}function U(){for(var e=N,t=e.length,n=[],a=0;t>a;a++){for(var l=[],i=0;i<V.fields.length;i++){var r=V.fields[i];r.visible&&!angular.isUndefined(r.field)&&l.push(x(r,e[a]))}n.push(l)}return n}function j(){for(var e=[],t=0;t<V.fields.length;t++){var n=V.fields[t];n.visible&&!angular.isUndefined(n.field)&&e.push(n.name)}return e}var z,V=this,N=e.data,I=[],W=[];V.filterTypes=[{name:"Szukaj w",value:"filter"},{name:"Mniejszy od",value:"lessThanOrEqualTo"},{name:"Większy od",value:"greaterThanOrEqualTo"}],V.getIndex=m,V.rowStyle=T,V.getValue=x,V.changeSorting=w,V.getFieldClass=k,V.showPagination=h,V.updatePagination=v,V.selectMultiple=c,V.showFilters=f,V.addFilter=F,V.removeFilter=S,V.updateFilter=M,V.export=U,V.exportHeader=j,V.expand=s,V.hasSum=y,V.sum=P,V.countColumns=g,l();var H=null}return e.$inject=["$scope","$filter","$q","$timeout"],{templateUrl:"ht-table/layout.html",require:"^ngModel",scope:{settings:"=htTable",data:"=ngModel"},controllerAs:"htTable",controller:e}}function t(){return function(e,t){t[0].focus()}}function n(){return function(e){for(var t=[],n=e.length,a=0;n>a;a++)(angular.isUndefined(e[a].visible)||e[a].visible)&&t.push(e[a]);return t}}function a(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?e>=t:!1})}}function l(e){return function(t,n){return e(t,n,function(e,t){var n=function(e){return!isNaN(parseFloat(e))};return n(e)&&n(t)?t>=e:!1})}}function i(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function l(e,t,n){var a=[];return angular.forEach(e,function(e,l,i){a.push(t.call(n,e,l,i))}),a}function i(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,s){function u(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function d(e,t){return n(t)?function(t,n){return e(n,t)}:e}function g(e,n){var a=typeof e,l=typeof n;return a==l?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):l>a?-1:1}return i(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=l(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return d(function(e,t){return g(e,t)},n);if(a=e(t),a.constant){var l=a();return d(function(e,t){return g(e[l],t[l])},n)}}return d(function(e,t){return g(a(e),a(t))},n)}),r.call(a).sort(d(u,s))):a}}a.$inject=["filterFilter"],l.$inject=["filterFilter"],i.$inject=["$parse","naturalService"],angular.module("ht.tables",["ui.bootstrap","naturalSort","ngSanitize","ngCsv"]).directive("htTable",e).directive("htFocus",t).filter("greaterThanOrEqualTo",a).filter("lessThanOrEqualTo",l).filter("natural",i).filter("field",n)}(),/*!
